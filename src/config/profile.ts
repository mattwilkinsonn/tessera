// THE ONE FILE YOU EDIT to change your layout — the shipped default profile.
//
// This is the bundled default the binary loads when no user profile is found.
// To run your own layout, copy this file to `~/.config/tessera/profile.ts` (or
// point `$TESSERA_PROFILE` at it) and edit that copy; the binary resolves it at
// runtime. Editing this file in a checkout changes the built-in fallback.
//
// A neutral default with placeholder app names, meant to show the shape of
// every field.
//
...
// resolve a slot by name; this default keeps the stock names. Layout binds to
